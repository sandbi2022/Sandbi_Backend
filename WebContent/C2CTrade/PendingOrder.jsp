...
<%@ page import="com.C2C.FindOrders"%>
<%@ page import="com.C2C.C2CTrade"%>
    	<%
	...
	StringBuilder sb = new StringBuilder();
	   try (BufferedReader reader = request.getReader();) {
		...
		ArrayList<C2CTrade> PendingOrders = FindOrders.findPendingTrade(tradeType, tradePair);
		
		JSONObject jsonObject = new JSONObject();
		for(C2CTrade trade:PendingOrders){
			...
			tradeJson.put("maxAmount", trade.getMaxAmount());
			tradeJson.put("minAmount", trade.getMinAmount());
